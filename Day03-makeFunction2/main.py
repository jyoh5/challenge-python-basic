...
def add_to_dict(my_dict, key="", value=""):
  if not isinstance(my_dict, dict):
    ...
    if not key in my_dict.keys():
      ...
      print(f"{key} is already on the ditionary. Won't add.") 


def get_from_dict(my_dict, key=""):
  if not isinstance(my_dict, dict):
    print(f"You need to send a dictionary. you sent: {type(my_dict)}");
  elif key == "":
...
def update_word(my_dict, key="", value=""):
  if not isinstance(my_dict, dict):
    print(f"You need to send a dictionary. you sent: {type(my_dict)}");
  elif key == "" or value == "":
...
def delete_from_dict(my_dict, key=""):
  if not isinstance(my_dict, dict):
    ...
    if not key in my_dict.keys():
      print(f"{key} was not in this dict. Wont' delete") 
    else:
      del my_dict[key]
